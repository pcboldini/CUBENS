...
!  
    ...
    nsteps           = 1200000                            ! simulations steps
    intvCalcCFL      = 1                            ! interval CFL calculation
!
! ---------------------------------- I/O ---------------------------------- 
!     
    intvPrint        = 100                            ! on the screen
    readRestartFile  = -100000                          ! if <0, not read
    intvSaveRestart  = 100000                           ! interval save restart files
    saveRestartAfter = 0                           ! save restart files after which timestep
    intvSavePlanes   = 100000                            ! interval save planes
    savePlanesAfter  = 0                            ! save planes after which timestep
    intvSaveStats    = 200                            ! interval save statistics
    saveStatsAfter   = 900000                            ! save statistics after which timestep
