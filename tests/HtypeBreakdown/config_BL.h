...
!  
    ...
    nsteps           = 680000                       ! simulations steps
...
!     
    ...
    intvSaveRestart  = 1000                        ! interval save restart files
    saveRestartAfter = 650000                            ! save restart files after which timestep
    intvSavePlanes   = 10000                        ! interval save planes
    savePlanesAfter  = 650000                            ! save planes after which timestep
...
!
    ...
    jmax = 30                                       ! number of points in y
    kmax = 3000                                    ! number of points in z
    
    len_x = 20.0                                    ! wall-normal length
    len_y = 9.63                                    ! spanwise length

    Redelta_start = 316.2                          ! start Re_delta
    Redelta_end = 700                            ! end Re_delta
...
!
    ...
    pert_ReMid = 415                                ! Re_delta for mid point perturbation
