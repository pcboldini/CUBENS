    function [Lt,Lx,Ly,Lz,Lq,Vxx,Vxy,Vyy,Vxz,Vyz,Vzz]=LST_Calc_Matrix_fullP(Re0,Pr,Ec,FLOW_PR_LST,PRESSURE_PR_LST,THERMO_PR_LST,ENERGY_PR_LST)
    ...
    p=PRESSURE_PR_LST(1);
    p_T=PRESSURE_PR_LST(2);
    p_TT=PRESSURE_PR_LST(3);
    p_rho=PRESSURE_PR_LST(4);
    p_rhorho=PRESSURE_PR_LST(5);
    p_rhoT=PRESSURE_PR_LST(6);
    
    % Thermodynamic properties
    
    mu=THERMO_PR_LST(1);
    mu_T=THERMO_PR_LST(2);
	mu_TT=THERMO_PR_LST(3);
	mu_rho=THERMO_PR_LST(4);
	mu_rhorho=THERMO_PR_LST(5);
	mu_rhoT=THERMO_PR_LST(6);
	kappa=THERMO_PR_LST(7);
	kappa_T=THERMO_PR_LST(8);
	kappa_TT=THERMO_PR_LST(9);
	kappa_rho=THERMO_PR_LST(10);
	kappa_rhorho=THERMO_PR_LST(11);
	kappa_rhoT=THERMO_PR_LST(12);
