function [LST_SPECTRUM] = LST_Calc_PR(BL_PARA,LST_PARA,LST_MESH,FLOW_PR_LST,PRESSURE_PR_LST,THERMO_PR_LST,ENERGY_PR_LST);
    Pr=BL_PARA.Pr_inf;
    Ec=BL_PARA.Ec_inf;    
    ...
    for i=1:N_LST
        ...
        [Lt,Lx,Ly,Lz,Lq,Vxx,Vxy,Vyy,Vxz,Vyz,Vzz]=LST_Calc_Matrix_PR(Re0,Pr,Ec,FLOW_PR_LST(i,:),PRESSURE_PR_LST(i,:),THERMO_PR_LST(i,:),ENERGY_PR_LST(i,:));
