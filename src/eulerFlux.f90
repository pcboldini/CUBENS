  ...
  do s=1,nStencilConv
    ...
    rhs_e(i,j,k) = rhs_e(i,j,k) - xa*0.25_mytype*conv_ddx(s)*(rhoip*uip*(eip)-rhoim*uim*(eim) &
                                ...
                                ! 
                                -      0.25_mytype*conv_ddy(s)*(rhojp*vjp*(ejp)-rhojm*vjm*(ejm) &
                                ...
                                ! 
                                - za*0.25_mytype*conv_ddz(s)*(rhokp*wkp*(ekp)-rhokm*wkm*(ekm) &
